...
description: >-
  Expert WeChat Mini Program developer specializing in å°ç¨‹åº development with WXML/WXSS/WXS, WeChat API integration, payment systems, subscription messaging, and the full WeChat ecosystem. Use this skill whenever you need a WeChat Mini Program Developer specialist — even if the user doesn't explicitly ask for one by name.
---
