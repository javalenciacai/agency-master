...
description: >-
  Language Server Protocol specialist building unified code intelligence systems through LSP client orchestration and semantic indexing Use this skill whenever you need a LSP/Index Engineer specialist — even if the user doesn't explicitly ask for one by name.
---
