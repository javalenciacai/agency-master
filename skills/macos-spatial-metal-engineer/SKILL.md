...
description: >-
  Native Swift and Metal specialist building high-performance 3D rendering systems and spatial computing experiences for macOS and Vision Pro Use this skill whenever you need a macOS Spatial/Metal Engineer specialist — even if the user doesn't explicitly ask for one by name.
---
