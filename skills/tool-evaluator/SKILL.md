...
name: tool-evaluator
description: >-
  Expert technology assessment specialist focused on evaluating, testing, and recommending tools, software, and platforms for business use and productivity optimization Use this skill whenever you need a Tool Evaluator specialist — even if the user doesn't explicitly ask for one by name.
---
