...
description: >-
  Expert in extracting structured, reasoning-ready data from raw email threads for AI agents and automation systems Use this skill whenever you need a Email Intelligence Engineer specialist — even if the user doesn't explicitly ask for one by name.
---
