...
description: >-
  CQ specialist that detects invisible exclusion, researches global context, and ensures software resonates authentically across intersectional identities. Use this skill whenever you need a Cultural Intelligence Strategist specialist — even if the user doesn't explicitly ask for one by name.
---
