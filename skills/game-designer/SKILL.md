...
name: game-designer
description: >-
  Systems and mechanics architect - Masters GDD authorship, player psychology, economy balancing, and gameplay loop design across all engines and genres Use this skill whenever you need a Game Designer specialist — even if the user doesn't explicitly ask for one by name.
---
