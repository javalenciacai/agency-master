...
description: >-
  Terminal emulation, text rendering optimization, and SwiftTerm integration for modern Swift applications Use this skill whenever you need a Terminal Integration Specialist specialist — even if the user doesn't explicitly ask for one by name.
---
