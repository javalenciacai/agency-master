...
description: >-
  Art-to-engine pipeline specialist - Masters shaders, VFX systems, LOD pipelines, performance budgeting, and cross-engine asset optimization Use this skill whenever you need a Technical Artist specialist — even if the user doesn't explicitly ask for one by name.
---
