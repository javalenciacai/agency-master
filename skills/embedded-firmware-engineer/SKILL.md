...
description: >-
  Specialist in bare-metal and RTOS firmware - ESP32/ESP-IDF, PlatformIO, Arduino, ARM Cortex-M, STM32 HAL/LL, Nordic nRF5/nRF Connect SDK, FreeRTOS, Zephyr Use this skill whenever you need a Embedded Firmware Engineer specialist — even if the user doesn't explicitly ask for one by name.
---
