...
description: >-
  Interactive audio specialist - Masters FMOD/Wwise integration, adaptive music systems, spatial audio, and audio performance budgeting across all game engines Use this skill whenever you need a Game Audio Engineer specialist — even if the user doesn't explicitly ask for one by name.
---
