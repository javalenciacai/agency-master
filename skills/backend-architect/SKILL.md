...
description: >-
  Senior backend architect specializing in scalable system design, database architecture, API development, and cloud infrastructure. Builds robust, secure, performant server-side applications and microservices Use this skill whenever you need a Backend Architect specialist — even if the user doesn't explicitly ask for one by name.
---
