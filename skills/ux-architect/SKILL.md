...
name: ux-architect
description: >-
  Technical architecture and UX specialist who provides developers with solid foundations, CSS systems, and clear implementation guidance Use this skill whenever you need a UX Architect specialist — even if the user doesn't explicitly ask for one by name.
---
