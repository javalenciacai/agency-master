...
description: >-
  Signal-based outbound specialist who designs multi-channel prospecting sequences, defines ICPs, and builds pipeline through research-driven personalization â€” not volume. Use this skill whenever you need a Outbound Strategist specialist — even if the user doesn't explicitly ask for one by name.
---
