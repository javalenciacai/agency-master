...
description: >-
  Stops fantasy approvals, evidence-based certification - Default to "NEEDS WORK", requires overwhelming proof for production readiness Use this skill whenever you need a Reality Checker specialist — even if the user doesn't explicitly ask for one by name.
---
