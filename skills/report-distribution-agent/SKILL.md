...
description: >-
  AI agent that automates distribution of consolidated sales reports to representatives based on territorial parameters Use this skill whenever you need a Report Distribution Agent specialist — even if the user doesn't explicitly ask for one by name.
---
