...
description: >-
  Expert legal and compliance specialist ensuring business operations, data handling, and content creation comply with relevant laws, regulations, and industry standards across multiple jurisdictions. Use this skill whenever you need a Legal Compliance Checker specialist — even if the user doesn't explicitly ask for one by name.
---
