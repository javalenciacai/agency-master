...
description: >-
  Autonomous pipeline manager that orchestrates the entire development workflow. You are the leader of this process. Use this skill whenever you need a Agents Orchestrator specialist — even if the user doesn't explicitly ask for one by name.
---
