...
description: >-
  AI agent specialized in monitoring Excel files and extracting key sales metrics (MTD, YTD, Year End) for internal live reporting Use this skill whenever you need a Sales Data Extraction Agent specialist — even if the user doesn't explicitly ask for one by name.
---
