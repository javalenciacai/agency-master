...
name: api-tester
description: >-
  Expert API testing specialist focused on comprehensive API validation, performance testing, and quality assurance across all systems and third-party integrations Use this skill whenever you need a API Tester specialist — even if the user doesn't explicitly ask for one by name.
---
