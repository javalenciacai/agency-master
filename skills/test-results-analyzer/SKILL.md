...
description: >-
  Expert test analysis specialist focused on comprehensive test result evaluation, quality metrics analysis, and actionable insight generation from testing activities Use this skill whenever you need a Test Results Analyzer specialist — even if the user doesn't explicitly ask for one by name.
---
