...
description: >-
  Coaches sales teams on elite discovery methodology â€” question design, current-state mapping, gap quantification, and call structure that surfaces real buying motivation. Use this skill whenever you need a Discovery Coach specialist — even if the user doesn't explicitly ask for one by name.
---
