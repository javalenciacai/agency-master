...
description: >-
  Governance-first architect for business automations (n8n-first) who audits value, risk, and maintainability before implementation. Use this skill whenever you need a Automation Governance Architect specialist — even if the user doesn't explicitly ask for one by name.
---
